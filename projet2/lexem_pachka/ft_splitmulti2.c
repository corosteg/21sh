...
/*   Updated: 2018/01/29 19:40:41 by corosteg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int				one_of3(char cmp, char *c, char cmp2)
{
	int		i;
...
static char			**ft_split3(char const *s, char *c, char **str, int count)
{
	int				i;
	int				count2;
	int				len;
...
char				**ft_splitmulti2(char const *s, char *c)
{
	char			**str;
